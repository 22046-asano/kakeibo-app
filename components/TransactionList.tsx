...
import { ReceiptText, Trash2, Edit2 } from 'lucide-react';
    ...
    <div className="bg-white rounded-2xl p-4 sm:p-5 shadow-sm border border-slate-200/80">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-bold text-slate-800">収支明細一覧</h2>
        </div>
      ...
      {transactions.length === 0 ? (
        <div className="py-12 text-center text-slate-400">
          <p className="text-sm">データが登録されていません</p>
              ...
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <div className="flex items-center gap-2 text-xs text-slate-400 mt-0.5">
                    <span>{t.date}</span>
                    {t.memo && <span className="truncate max-w-[120px] sm:max-w-[200px]">・{t.memo}</span>}
                  </div>
                </div>
              </div>
